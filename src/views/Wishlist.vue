...
import { avatarp, kitchenp, bedroomp, living_roomp, product_chairp } from '@/constants/assets';
</script>
<template>
    <!-- TODO: REFACTOR -->
    ...
    <nav class="mx-auto w-full mt-4 max-w-[1200px] px-5">
      ...
      <section
        class="col-span-12 w-full container flex-grow mx-auto max-w-[1200px] border-b py-5 lg:flex lg:flex-row lg:py-10"
      >
        <!-- sidebar  -->
