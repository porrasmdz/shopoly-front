...
<template>
    ...
    <section
      class="hidden col-span-12 splide mx-auto max-w-[1200px] px-5 py-2"
    ...
    <div class="col-span-12 mx-auto max-w-[1200px] px-5">
      <section
    ...
    <!-- Recommendations -->
    <section
      class="col-span-12 mx-auto grid max-w-[1200px] grid-cols-2 gap-3 px-5 pb-10 lg:grid-cols-4"
    >
      <!-- 1 -->
