...
import { avatarp } from '@/constants/assets';
</script>
<template>
    <!-- TODO: REFACTOR -->
    <!-- breadcrumbs  -->
    ...
    <section class="col-span-12 w-full container mx-auto lg:-mt-16  flex-grow max-w-[1200px] border-b py-5 lg:flex lg:flex-row lg:py-10">
        <!-- sidebar  -->
        <section class="hidden w-[300px] flex-shrink-0 px-4 lg:block">
            <div class="border-b py-5">
                <div class="flex items-center">
                    <img class="h-[50px] w-[50px] rounded-full object-cover" :src="avatarp"
